...
import nl.quintor.studybits.indy.wrapper.IndyLedger;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    String poolName = PoolUtils.createPoolLedgerConfig("10.31.200.120", "testPool" + System.currentTimeMillis());

                    IndyPool indyPool = new IndyPool(poolName);
                    LookupRepository lookupRepository = new IndyLedger(indyPool.getPool());
                    IndyWallet studentWallet = IndyWallet.create(lookupRepository, poolName, "student_wallet" + System.currentTimeMillis(), null);
